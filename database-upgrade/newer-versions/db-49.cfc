...
<cffunction name="executeUpgrade" localmode="modern" access="public" returntype="boolean">
	...
	if(!arguments.dbUpgradeCom.executeQuery(this.datasource, "ALTER TABLE `menu`   
	  ADD COLUMN `section_id` INT(11) UNSIGNED DEFAULT 0  NOT NULL AFTER `menu_deleted`, 
	  DROP INDEX `NewIndex2`,
	  ADD  UNIQUE INDEX `NewIndex2` (`site_id`, `section_id`, `menu_codename`, `menu_deleted`),
	  DROP INDEX `NewIndex1`,
	  ADD  UNIQUE INDEX `NewIndex1` (`site_id`, `section_id`, `menu_name`, `menu_deleted`)")){
		return false;
	}
	if(!arguments.dbUpgradeCom.executeQuery(this.datasource, "ALTER TABLE `blog`   
	  ...
	  ADD  INDEX `NewIndex2` (`site_id`, `section_id`, `blog_deleted`)")){
		return false;
	}
	...
	if(!arguments.dbUpgradeCom.executeQuery(this.datasource, "ALTER TABLE `blog_category`   
	  ADD COLUMN `section_id` INT(11) UNSIGNED DEFAULT 0  NOT NULL AFTER `blog_category_deleted`, 
	  ADD  INDEX `NewIndex2` (`site_id`, `section_id`, `blog_category_deleted`)")){
		return false;
	}

	if(!arguments.dbUpgradeCom.executeQuery(this.datasource, "ALTER TABLE `content`   
	  ADD COLUMN `section_id` INT(11) UNSIGNED DEFAULT 0  NOT NULL AFTER `site_x_option_group_set_id`, 
	  ADD  INDEX `NewIndex4` (`site_id`, `section_id`, `content_deleted`)")){
		return false;
	}
	...
	if(!arguments.dbUpgradeCom.executeQuery(this.datasource, "ALTER TABLE `site_option`   
	  ADD COLUMN `section_id` INT(11) UNSIGNED DEFAULT 0  NOT NULL AFTER `site_option_reservation_type_id_list`, 
	  ADD  INDEX `NewIndex3` (`site_id`, `section_id`, `site_option_deleted`)")){
		return false;
	}

	if(!arguments.dbUpgradeCom.executeQuery(this.datasource, "ALTER TABLE `site_option_group`   
	  ADD COLUMN `section_id` INT(11) UNSIGNED DEFAULT 0  NOT NULL AFTER `site_option_group_ajax_enabled`, 
	  ADD  INDEX `NewIndex2` (`site_id`, `section_id`, `site_option_group_deleted`)")){
		return false;
	}

	if(!arguments.dbUpgradeCom.executeQuery(this.datasource, "CREATE TABLE `layout_config`(  
	...
	if(!arguments.dbUpgradeCom.executeQuery(this.datasource, "CREATE TABLE `section`(  
	...
	if(!arguments.dbUpgradeCom.executeQuery(this.datasource, "CREATE TABLE `section_content_type`(  
	...
	if(!arguments.dbUpgradeCom.executeQuery(this.datasource, "CREATE TABLE `layout_preset`( 
		...
		`layout_preset_name` VARCHAR(255) NOT NULL DEFAULT '',
	...
	if(!arguments.dbUpgradeCom.executeQuery(this.datasource, "CREATE TABLE `layout_page`( 
		`layout_page_id` INT(11) UNSIGNED NOT NULL DEFAULT 0,
		`layout_page_uuid` CHAR(35) NOT NULL DEFAULT '',
		`layout_page_name` VARCHAR(255) NOT NULL DEFAULT '',
		`layout_preset_id` INT(11) UNSIGNED NOT NULL DEFAULT 0,
	  ...
	  UNIQUE INDEX `NewIndex1` (`site_id`, `layout_page_name`, `layout_page_deleted`)
	) ENGINE=INNODB CHARSET=utf8 COLLATE=utf8_bin")){
		return false;
	}

	if(!arguments.dbUpgradeCom.executeQuery(this.datasource, "CREATE TABLE `landing_page`( 
		...
		`landing_page_meta_title` VARCHAR(255) NOT NULL DEFAULT '',
		`layout_page_id` INT(11) UNSIGNED NOT NULL DEFAULT 0,
	...
	if(!arguments.dbUpgradeCom.executeQuery(this.datasource, "CREATE TABLE `landing_page_x_widget`( 
		...
		`landing_page_x_widget_json_data` LONGTEXT NOT NULL,
	...
	if(!arguments.dbUpgradeCom.executeQuery(this.datasource, "CREATE TABLE `layout_row`( 
		...
		`site_id` INT(11) UNSIGNED NOT NULL DEFAULT 0,
		`layout_row_updated_datetime` DATETIME NOT NULL DEFAULT '0000-00-00 00:00:00',
	...
	if(!arguments.dbUpgradeCom.executeQuery(this.datasource, "CREATE TABLE `layout_column`( 
		`layout_column_id` INT(11) UNSIGNED NOT NULL DEFAULT 0,
		`layout_row_id` INT(11) UNSIGNED NOT NULL DEFAULT 0,
		`layout_column_uuid` CHAR(35) NOT NULL DEFAULT '',
		`layout_page_id` INT(11) UNSIGNED NOT NULL DEFAULT 0,
		`site_id` INT(11) UNSIGNED NOT NULL DEFAULT 0,
		`layout_column_updated_datetime` DATETIME NOT NULL DEFAULT '0000-00-00 00:00:00',
		`layout_column_deleted` INT(11) UNSIGNED NOT NULL DEFAULT 0,
	  PRIMARY KEY (`site_id`, `layout_column_id`, `layout_column_deleted`),
	  KEY `NewIndex1` (`site_id`, `layout_page_id`, `layout_column_deleted`),
	  KEY `NewIndex2` (`site_id`, `layout_row_id`, `layout_column_deleted`)
	) ENGINE=INNODB CHARSET=utf8 COLLATE=utf8_bin")){
		return false;
	}

	if(!arguments.dbUpgradeCom.executeQuery(this.datasource, "CREATE TABLE `layout_column_x_widget`( 
	...
	if(!arguments.dbUpgradeCom.executeQuery(this.datasource, "CREATE TABLE `layout_row_x_breakpoint`( 
	...
	if(!arguments.dbUpgradeCom.executeQuery(this.datasource, "CREATE TABLE `layout_column_x_breakpoint`( 
	...
	if(!arguments.dbUpgradeCom.executeQuery(this.datasource, "CREATE TABLE `layout_column_x_widget_x_breakpoint`( 
	...
	if(!arguments.dbUpgradeCom.executeQuery(this.datasource, "CREATE TABLE `widget`(
		`widget_id` INT(11) UNSIGNED NOT NULL DEFAULT 0,
