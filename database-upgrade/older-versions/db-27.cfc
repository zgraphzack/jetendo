...
<cffunction name="executeUpgrade" localmode="modern" access="public" returntype="boolean">
	...
	<cfscript>
	if(!arguments.dbUpgradeCom.executeQuery(this.datasource, "CREATE TABLE `dns_health`(  
	...
	if(!arguments.dbUpgradeCom.executeQuery(this.datasource, "CREATE TABLE `dns_ip`(  
	...
	if(!arguments.dbUpgradeCom.executeQuery(this.datasource, "CREATE TABLE `dns_zone`(  
	...
	if(!arguments.dbUpgradeCom.executeQuery(this.datasource, "CREATE TABLE `dns_record`(  
...
if(!arguments.dbUpgradeCom.executeQuery(this.datasource, "CREATE TABLE `dns_group`(  
