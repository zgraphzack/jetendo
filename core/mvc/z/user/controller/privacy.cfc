...
<cfelse><cfset privacyTextMissing=true>
</cfif>
...
<h2>Quick Links</h2>
<ul><li><a href="<cfif request.zos.cgi.SERVER_PORT NEQ "443">#request.zos.globals.domain#<cfelse>#request.zos.globals.securedomain#</cfif>/z/user/preference/index">Update Your Communication Preferences</a></li>
<li><a href="<cfif request.zos.cgi.SERVER_PORT NEQ "443">#request.zos.globals.domain#<cfelse>#request.zos.globals.securedomain#</cfif>/z/user/out/index">Unsubscribe from our mailing list</a></li></ul>
...
<p>At this time, we don't share information with other companies so you will only receive emails from our company.  If this changes in the future, our privacy policy will be updated and a clear notice will be given before the user signs up regarding how the information will be shared.</p>
...
<p>If you do not want to receive e-mail from us in the future, please let us know by visiting us at <a href="<cfif request.zos.cgi.SERVER_PORT NEQ "443">#request.zos.globals.domain#<cfelse>#request.zos.globals.securedomain#</cfif>/z/user/out/index"><cfif request.zos.cgi.SERVER_PORT NEQ "443">#request.zos.globals.domain#<cfelse>#request.zos.globals.securedomain#</cfif>/z/user/out/index</a>.</p>
<p>If you should change your mind and want to receive our emails, please let us know by visiting us at <a href="<cfif request.zos.cgi.SERVER_PORT NEQ "443">#request.zos.globals.domain#<cfelse>#request.zos.globals.securedomain#</cfif>/z/user/preference/index"><cfif request.zos.cgi.SERVER_PORT NEQ "443">#request.zos.globals.domain#<cfelse>#request.zos.globals.securedomain#</cfif>/z/user/preference/index</a>.</p>
<p>If you supply us with your postal address on-line you may receive periodic mailings from us with information on new products and services or upcoming events.   If you do not wish to receive such mailings, please let us know by visiting us at <a href="<cfif request.zos.cgi.SERVER_PORT NEQ "443">#request.zos.globals.domain#<cfelse>#request.zos.globals.securedomain#</cfif>/z/user/preference/index"><cfif request.zos.cgi.SERVER_PORT NEQ "443">#request.zos.globals.domain#<cfelse>#request.zos.globals.securedomain#</cfif>/z/user/preference/index</a>.</p>
<p>Please provide us with your exact name and address. We will be sure your name is removed from the list we share with other organizations  </p><p>Persons who supply us with their telephone numbers on-line may receive telephone contact from us with information regarding new products and services or upcoming events. If you do not wish to receive such telephone calls, please let us know by visiting us at <a href="<cfif request.zos.cgi.SERVER_PORT NEQ "443">#request.zos.globals.domain#<cfelse>#request.zos.globals.securedomain#</cfif>/z/user/preference/index"><cfif request.zos.cgi.SERVER_PORT NEQ "443">#request.zos.globals.domain#<cfelse>#request.zos.globals.securedomain#</cfif>/z/user/preference/index</a>.</p>
