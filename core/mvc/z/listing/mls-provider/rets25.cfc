...
<cfoutput>
	...
	this.arrColumns=listtoarray("activestatusdate,additionalapplicantfee,additionalmembershipavailableyn,additionalparcelyn,additionalpetfees,additionalrooms,additionaltaxids,address,listoffice_mui,adjoiningproperty,listagent_mui,agentfax,agenthomepage,agentofficeext,agentpagercell,airconditioning,altaddress,alternatekeyfolionum,annualcddfee,annualexpenses,annualgrossincome,annualnetincome,annualrent,annualtotalscheduledincome,appliancesincluded,applicationfee,architecturalstyle,assocapprreqyn,associationapplicationfee,associationapprovalfee,associationfeeincludes,auctionyn,availability,availabilitycom,avgrent1bed1bath,avgrent2bed1bath,avgrent2bed2bath,avgrent3bed1bath,avgrent3bed2bath,awcremarks,bathsfull,bathshalf,bathstotal,assocapprovreqyn,bedstotal,blockparcel,buildingnamenumber,buildingnumfloors,campersqft,cddyn,cdom,ceilingheight,ceilingtype,classofspace,closedate,closeprice,colistagentdirectworkphone,colistagentfullname,colistagentmlsid,yrsofownerpriortoleasingreqyn,colistofficemlsid,colistofficename,communityfeatures,complexcommunitynamenccb,complexdevelopmentname,condoenvironmentyn,condofees,condofeesterm,approvalprocess,constructionstatus,contractstatus,convertedresidenceyn,cosellingagentfullname,cosellingagentmlsid,cosellingofficemlsid,cosellingofficename,country,countylandusecode,countyorparish,countypropertyusecode,currentadjacentuse,currentprice,dateavailable,buyerspremium,disastermitigation,enddateoflse,easementscom,disclosures,dom,listofficeheadoffice_mui,doorheight,doorwidth,dprurl,buildingelevatoryn,dprurl2,dpryn,drivingdirections,easements,eavesheight,efficienciesnumberof,efficiencyavgrent,condolandincludedyn,electricalservice,elementaryschool,estannualmarketincome,auctiontype,existingleasebuyoutallow,expectedclosingdate,exteriorconstruction,exteriorfeatures,fences,financialsource,financingavailable,financingterms,fireplacedescription,fireplaceyn,flexspacesqft,floodzonecode,floorcovering,floornum,floorsinunit,forleaseyn,foundation,freezerspaceyn,frontagedescription,frontexposure,frontfootage,furnishings,futurelanduse,garagecarport,garagedimensions,garagedoorheight,garagefeatures,greencertifications,numofownyrspriortolse,greenenergyfeatures,greenlandscaping,greensiteimprovements,greenwaterfeatures,heatingandfuel,canpropertybelsedyn,hersindex,highschool,hoacommonassn,hoafee,hoapaymentschedule,homesteadyn,housingforolderpersons,idxoptinyn,idxvowdisplaycommentsyn,indoorairquality,interiorfeatures,interiorlayout,internetyn,kitchenfeatures,landleasefee,lastdateavailable,lastmonthsrent,leasefee,leaseprice,leasepriceperacre,leasepricepersf,leasepriceperyr,leaseremarks,leaseterms,legaldescription,legalsubdivisionname,lengthoflease,listagentdirectworkphone,listagentemail,listagentfullname,listagentmlsid,listingcontractdate,listingtype,listingwphotoapprovedyn,listofficemlsid,listofficename,listofficephone,listprice,location,longtermyn,lotdimensions,lotnum,lotsizeacres,lotsizesqft,lpsqft,lsclistside,lscsellside,maintenanceincludes,management,mandatoryfees,existlsetenantyn,masterbathfeatures,masterbedsize,matrix_unique_id,matrixmodifieddt,maxpetweight,mfrconsumeryn,mhwidth,middleorjuniorschool,millagerate,minimumdaysleased,minimumlease,miscellaneous,miscellaneous2,mlsareamajor,mlsnumber,modelmake,modelname,momaintamtadditiontohoa,monthlycondofeeamount,monthlyhoaamount,netleasablesqft,netoperatingincome,netoperatingincometype,newconstructionyn,nonrepcomp,num1bed1bath,num2bed1bath,num2bed2bath,num3bed1bath,num3bed2bath,numofaddparcels,currencymonthlyrentamt,numofbays,numofbaysdockhigh,numofbaysgradelevel,numofconferencemeetingrooms,numofhotelmotelrms,numofoffices,numofpets,mthtomthorweeklyyn,numofrestrooms,numtimesperyear,officefax,officeprimaryboardid,officeretailspacesqft,offmarketdate,offseasonrent,originalentrytimestamp,auctionfirm_website,originallistprice,otherexemptionsyn,otherfees,otherfeesamount,otherfeesterm,otherfeesyn,parcelnumber,parking,petdeposit,petfeenonrefundable,petrestrictions,petrestrictionsyn,petsallowedyn,petsize,photocount,photomodificationtimestamp,plannedunitdevelopmentyn,platbookpage,pool,pooldimensions,pooltype,porches,postalcode,postalcodeplus4,pricechangetimestamp,priceperacre,projectedcompletiondate,propertydescription,propertystatus,propertystyle,daystoclosed,propertystylecom,propertytype,propertyuse,providermodificationtimestamp,publicremarksnew,range,realtorinfo,realtoronlyremarks,recipsellagentname,recipsellofficename,rentalratetype,rentconcession,rentincludes,roadfrontage,roadfrontageft,additionallserestrict,roof,roomcount,seasonalrent,daysnoticetotenantifnotrenew,section,securitydeposit,sellingagentfullname,sellingagentmlsid,sellingofficemlsid,sellingofficename,showpropaddroninternetyn,auctionpropaccessyn,sidewalkyn,singleagentcomp,siteimprovements,soldremarks,spacetype,speciallistingtype,specialsaleprovision,specialtaxdisttampayn,splpratio,spsqft,sqftgross,sqftheated,sqfttotal,squarefootsource,statelandusecode,stateorprovince,statepropertyusecode,status,statuschangetimestamp,streetcity,streetdirprefix,streetdirsuffix,streetname,streetnumber,streetsuffix,studiodimensions,subdivisionnum,subdivisionsectionnumber,swsubdivcommunityname,swsubdivcondonum,taxes,taxyear,teamname,tempoffmarketdate,totalacreage,totalmonthlyexpenses,totalmonthlyrent,totalnumbuildings,totalunits,township,transbrokercomp,transportationaccess,unitcount,unitnumber,units,weeksavailable2015,usecode,utilities,virtualtourlink,virtualtoururl2,warehousespaceheated,warehousespacetotal,wateraccess,wateraccessyn,waterextras,waterextrasyn,waterfrontage,waterfrontageyn,waterfrontfeet,watername,waterview,waterviewyn,weeklyrent,weeksavailable2011,weeksavailable2012,weeksavailable2013,weeksavailable2014,windowcoverings,yearbuilt,zoning,zoningcompatibleyn", ",");
