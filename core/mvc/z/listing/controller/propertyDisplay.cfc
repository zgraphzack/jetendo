...
<cffunction name="contentTemplate" localmode="modern" output="yes" returntype="any">
	...
	<cfsavecontent variable="output">
		...
		if((structkeyexists(request.zos.userSession.groupAccess, "administrator") or structkeyexists(request.zos.userSession.groupAccess, "content_manager")) and contentConfig.contentEmailFormat EQ false){
