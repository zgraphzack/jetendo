		...
		<table style="border-spacing:0px;" class="table-list">
			...
			<tr>
				...
				<cfif currentMethod EQ "add">
					<input type="text" size="50" name="site_option_name" id="site_option_name" onkeyup="autofillFieldType(this.value);" value="#htmleditformat(form.site_option_name)#" onkeyup="var d1=document.getElementById('site_option_display_name');if(displayDefault){d1.value=this.value;}" onblur="var d1=document.getElementById('site_option_display_name');if(displayDefault){d1.value=this.value;}"><br />
