...
<cffunction name="getSearchFormField" localmode="modern" access="public"> 
	...
	<cfscript>
	return '<input type="text" name="#arguments.prefixString##arguments.row["#variables.type#_option_id"]#" onkeyup="#arguments.onChangeJavascript#" onpaste="#arguments.onChangeJavascript#" id="#arguments.prefixString##arguments.row["#variables.type#_option_id"]#" style="width:95%; min-width:95%;" value="#htmleditformat(arguments.value)#" size="8" />';
	</cfscript>
</cffunction>
...
<cffunction name="validateFormField" localmode="modern" access="public">
	...
	if(nv NEQ "" and not isNumeric(nv)){
		return { success:false, message: arguments.row["#variables.type#_option_display_name"]&" must be a number with no punctuation." };
	}
	return {success:true};
	</cfscript>
</cffunction>
...
<cffunction name="getTypeForm" localmode="modern" access="public">
	...
	<input type="radio" name="#variables.type#_option_type_id" value="17" onClick="setType(17);" <cfif value EQ "17">checked="checked"</cfif>/>
	Number<br />
	</cfsavecontent>
	<cfreturn output>
</cffunction> 
