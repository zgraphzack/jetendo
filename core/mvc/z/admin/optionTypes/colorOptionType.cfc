...
<cffunction name="getFormField" localmode="modern" access="public">
	...
	return { label: true, hidden: false, value:'##<input type="text" class="zColorInput" name="#arguments.prefixString##arguments.row["#variables.type#_option_id"]#" id="#arguments.prefixString##arguments.row["#variables.type#_option_id"]#" onkeyup="this.value.replace(''##'', '''');" style="width:90%;" value="#htmleditformat(application.zcore.functions.zso(arguments.dataStruct, '#arguments.prefixString##arguments.row["#variables.type#_option_id"]#'))#" />'};  
	</cfscript>
</cffunction>
...
<cffunction name="getListValue" localmode="modern" access="public">
	...
	<cfargument name="value" type="string" required="yes">
	<cfscript>
		return '<div style="width:25px; height:25px; background-color:##'&arguments.value&'; " title="##'&arguments.value&'"></div>';
	</cfscript>
</cffunction>
...
<cffunction name="onBeforeUpdate" localmode="modern" access="public">
	...
	<cfscript>	
	nv="";
	if(structkeyexists(arguments.dataStruct, arguments.prefixString&arguments.row["#variables.type#_option_id"])){
		nv=arguments.dataStruct[arguments.prefixString&arguments.row["#variables.type#_option_id"]];
	}
...
<cffunction name="getTypeForm" localmode="modern" access="public">
	...
	<input type="radio" name="#variables.type#_option_type_id" value="18" onClick="setType(18);" <cfif value EQ "18">checked="checked"</cfif>/>
	Color Picker<br />
	</cfsavecontent>
	<cfreturn output>
</cffunction> 
...
<cffunction name="getCreateTableColumnSQL" localmode="modern" access="public">
	<cfargument name="fieldName" type="string" required="yes">
	<cfscript>
	return "`#arguments.fieldName#` varchar(10) NOT NULL";
	</cfscript>
</cffunction>
</cfoutput>
</cfcomponent>