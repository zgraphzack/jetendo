...
<cffunction name="getSearchFormField" localmode="modern" access="public"> 
	...
	<cfscript>
	return '<input type="email" name="#arguments.prefixString##arguments.row["#variables.type#_option_id"]#" onkeyup="#arguments.onChangeJavascript#" onpaste="#arguments.onChangeJavascript#" style="width:95%;" id="#arguments.prefixString##arguments.row["#variables.type#_option_id"]#" value="#htmleditformat(arguments.value)#" size="8" />';
	</cfscript>
</cffunction>
...
<cffunction name="validateFormField" localmode="modern" access="public">
	...
	if(nv NEQ "" and not application.zcore.functions.zEmailValidate(nv)){
		return { success:false, message: arguments.row["#variables.type#_option_display_name"]&" must be a valid email address." };
	}
	return {success:true};
	</cfscript>
</cffunction>
...
<cffunction name="getFormField" localmode="modern" access="public">
	...
	<cfscript>
	return { label: true, hidden: false, value:'<input type="email" name="#arguments.prefixString##arguments.row["#variables.type#_option_id"]#" id="#arguments.prefixString##arguments.row["#variables.type#_option_id"]#" style="width:95%;" value="#htmleditformat(application.zcore.functions.zso(arguments.dataStruct, '#arguments.prefixString##arguments.row["#variables.type#_option_id"]#'))#" />'};  
	</cfscript> 
</cffunction>
...
<cffunction name="getTypeForm" localmode="modern" access="public">
	...
	<input type="radio" name="#variables.type#_option_type_id" value="10" onClick="setType(10);" <cfif value EQ "10">checked="checked"</cfif>/>
	Email<br />
	</cfsavecontent>
	<cfreturn output>
</cffunction> 
