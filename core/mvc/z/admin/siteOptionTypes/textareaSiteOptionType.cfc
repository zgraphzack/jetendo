...
<cffunction name="getSearchFormField" localmode="modern" access="public"> 
	...
	<cfscript>
	return '<input type="text" name="#arguments.prefixString##arguments.row.site_option_id#" onkeyup="#arguments.onChangeJavascript#" onpaste="#arguments.onChangeJavascript#" style="width:95%;" id="#arguments.prefixString##arguments.row.site_option_id#" value="#htmleditformat(arguments.value)#" size="8" />';
	</cfscript>
</cffunction>
...
<cffunction name="getFormField" localmode="modern" access="public">
	...
	<cfscript>
	return { label: true, hidden: false, value:'<textarea cols="10" rows="5" style="width:#application.zcore.functions.zso(arguments.optionStruct, 'editorwidth2',false,500)#px; height:#application.zcore.functions.zso(arguments.optionStruct, 'editorheight2',false,200)#px;" name="#arguments.prefixString##arguments.row.site_option_id#">#htmleditformat(arguments.dataStruct[arguments.prefixString&arguments.row.site_option_id])#</textarea>'};  
	</cfscript> 
</cffunction>
...
<cffunction name="getTypeForm" localmode="modern" access="public">
	...
	<input type="radio" name="site_option_type_id" value="1" onClick="setType(1);" <cfif value EQ 1>checked="checked"</cfif>/>
	Textarea<br />
