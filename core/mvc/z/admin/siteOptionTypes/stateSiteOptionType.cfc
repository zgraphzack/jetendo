...
<cffunction name="getSearchFormField" localmode="modern" access="public"> 
	...
	<cfscript>
	return application.zcore.functions.zStateSelect(arguments.prefixString&arguments.row.site_option_id, arguments.value, '', arguments.onChangeJavascript);
	</cfscript>
</cffunction>
...
<cffunction name="getFormField" localmode="modern" access="public">
	...
	<cfscript>
	return { label: true, hidden: false, value:application.zcore.functions.zStateSelect(arguments.prefixString&arguments.row.site_option_id, application.zcore.functions.zso(arguments.dataStruct, arguments.prefixString&arguments.row.site_option_id))};  
	</cfscript>
</cffunction>
...
<cffunction name="getTypeForm" localmode="modern" access="public">
	...
	<input type="radio" name="site_option_type_id" value="19" onClick="setType(19);" <cfif value EQ "19">checked="checked"</cfif>/>
	State<br />
	</cfsavecontent>
	<cfreturn output>
</cffunction> 
