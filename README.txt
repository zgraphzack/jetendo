...
The database schema and required data are not included in the current project.  We're trying to build a implement a scripted database versioning system before releasing it.
