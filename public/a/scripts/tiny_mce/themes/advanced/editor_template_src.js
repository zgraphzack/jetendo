...
*/
		...
		_mceInsertZSAImage : function(ui, v) {
			...
			ed.windowManager.open({
				url : tinymce.baseURL + '/themes/advanced/zsaimage.htm',
				width : 600 + parseInt(ed.getLang('advanced.anchor_delta_width', 0)),
				height : 380 + parseInt(ed.getLang('advanced.anchor_delta_height', 0)),
				inline : true
			}, {
				theme_url : this.url
			});
